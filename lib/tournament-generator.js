...
class TournamentGenerator {
	...
	/**
	 * Returns the region string with the highest count among players. This
	 * region should be ignored in collision score calculations.
	 * @return {string} Ignored region string.
	 */
	getIgnoredRegion() {
	 ...
	 * @return {Object} - Plain object containing poolCount, ignoredRegion,
	 *   and targetCollisionScore properties.
	 */
